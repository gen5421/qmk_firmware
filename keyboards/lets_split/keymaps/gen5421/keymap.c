...
[_QWERTY] = KEYMAP( \
  ...
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_TAB,  KC_NMLC, KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, \
...
[_LOWER] = KEYMAP( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY  \
),

[_RAISE] = KEYMAP( \
  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, KC_ENT,  KC_4,    KC_5,    KC_6,    KC_ASTR, \
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_EQL,  KC_1,    KC_2,    KC_3,    KC_SLSH, \
  _______, _______, _______, _______, _______, KC_BSPC, KC_SPC,  KC_PERC, KC_0,    KC_DOT,  KC_MINS, KC_PLUS  \
),


[_ADJUST] =  KEYMAP( \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_UP,   KC_PGUP, _______, \
  _______, _______, _______, KC_LSFT, _______, _______, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END , \
